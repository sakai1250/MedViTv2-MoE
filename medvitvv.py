...
MedViTVV: A Robust Vision Transformer for Generalized Medical Image Classification with Orthogonal Rational KAN.
"""
from functools import partial
import math
# from fasterkan import FasterKAN as KAN, SplineLinear
from orkan import ORKAN as KAN
import torch
...
@register_model
def MedViTVV_tiny(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay= None, **kwargs):
...
@register_model
def MedViTVV_small(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay= None, **kwargs):
    model = MedViT(stem_chs=[64, 32, 64],
                   depths=[2, 2, 6, 2],
                   dims=[64, 128, 256, 512],
                   path_dropout=0.1, **kwargs)
...
@register_model
def MedViTVV_base(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay= None, **kwargs):
    model = MedViT(stem_chs=[64, 32, 64],
                   depths=[2, 2, 6, 2],
                   dims=[96, 192, 384, 768],
...
@register_model
def MedViTVV_large(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay= None, **kwargs):
    model = MedViT(stem_chs=[64, 32, 64],
                   depths=[2, 2, 6, 2],
